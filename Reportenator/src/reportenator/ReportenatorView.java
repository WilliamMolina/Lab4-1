 ...
 */
public class ReportenatorView extends FrameView {
    
    public ReportenatorView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        reportenator.Datos d = new reportenator.Datos();
    ...
    public void deleteRecord() {
        ...
        List<reportenator.Datos> toRemove = new ArrayList<reportenator.Datos>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            reportenator.Datos d = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(d);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<reportenator.Datos> merged = new ArrayList<reportenator.Datos>(list.size());
                for (reportenator.Datos d : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = ReportenatorApp.getApplication().getMainFrame();
            aboutBox = new ReportenatorAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        ReportenatorApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(reportenator.ReportenatorApp.class).getContext().getResourceMap(ReportenatorView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(reportenator.ReportenatorApp.class).getContext().getActionMap(ReportenatorView.class, this);
    ...
    private java.util.List<reportenator.Datos> list;
